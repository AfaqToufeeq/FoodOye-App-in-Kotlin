...
import com.app.foodoyeadmin.databinding.ActivityRegisterBinding
...
class registerActivity : AppCompatActivity() {
    ...
    {
        auth = Firebase.auth
        database = FirebaseDatabase.getInstance().getReferenceFromUrl("https://fooddelivery-foodoye-default-rtdb.firebaseio.com/")
